...
__webpack_require__(/*! ./anchors.js */ "./resources/js/anchors.js");

__webpack_require__(/*! ./cookies.js */ "./resources/js/cookies.js");

__webpack_require__(/*! ./external-links.js */ "./resources/js/external-links.js");

__webpack_require__(/*! ./prism.js */ "./resources/js/prism.js");

__webpack_require__(/*! ./scrollspy.js */ "./resources/js/scrollspy.js");

var phrases = ["🍳 What's cookin', home skillet?", "🐢 Cowabunga!", "🥤 Who loves orange soda?", "🔩 I put the screw in the tuna!", "🤪 I know you are but what am I?", "💣 You da bomb!", "🤚 Talk to the hand!", "🔥 Let's get crunk!", "✂️ Cut. It. Out.", "💥 These docs are all that and a bag of chips."];
console.log(phrases[Math.floor(Math.random() * phrases.length)]);
Prism.highlightAll(); // alert(document.cookie)
...
if (tableOfContents) {
  var headers = [].slice.call(document.querySelectorAll('h2')).map(function (_ref) {
    var id = _ref.id,
...
function highlightLink(id) {
  var highlight = document.querySelector(".toc a[href=\"#".concat(id, "\"]"));
...
__webpack_require__(/*! /Users/aperture/sites/ggna/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/aperture/sites/ggna/resources/css/tailwind.css */"./resources/css/tailwind.css");
